    ...
    public class LLMConfiguration
    {
        ...
        public bool IsConfigured
        {
            get
            {
                ...
                // GitHub Copilot can use device flow authentication, so API key is optional
                if (Type == ClientType.GitHubCopilot)
                    return true;
        ...
        private static string GetDefaultModelForEndpoint(string endpoint)
        {
            ...
            if (endpoint.Contains("githubcopilot.com", StringComparison.OrdinalIgnoreCase) ||
        ...
        public string GetConfigurationStatus()
        {
            ...
            return "LLM not configured. Set:\n" +
                   ...
                   "  LLM_API_KEY (your API key or GitHub token)\n" +
